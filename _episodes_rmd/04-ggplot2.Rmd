...
interviews = read.csv('c:/users/vlala/downloads/SAFI_clean.csv')
...
1. changing the transparency of the points (using `alpha`)
2. jittering the location of the points (using `geom_jitter()`)
...
PS: ggplot2 understands both the Commonwealth English and American English spellings
for colour, i.e., you can use either "color" or "colour"
