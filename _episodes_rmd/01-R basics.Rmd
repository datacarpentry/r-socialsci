...
You can use the '.' character as part of the name but this is not recommended. If you wish make longer variable names more readable, using the '_' 
character helps. 
...
If you type these two lines at the console or run them (one at a time) from a script, you will just recieve the standard '>' prompt as a response.
