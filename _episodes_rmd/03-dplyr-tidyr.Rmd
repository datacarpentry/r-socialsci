...
conditions together by using logical operators between each condition. 

```{r, purl = FALSE}
# one condition
filter(interviews, village == "Chirodzo")
# multiple conditions (output dataframe satisfies all specified conditions)
filter(interviews, village == "Chirodzo" & rooms > 1 & no_meals > 2)
# multiple conditions (output dataframe satisfies either of the specified conditions)
