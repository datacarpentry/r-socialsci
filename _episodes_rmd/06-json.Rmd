...
json_data <- read_json(path='https://github.com/datacarpentry/r-socialsci/blob/main/data/SAFI.json')
...
json_data <- read_json(path='https://github.com/datacarpentry/r-socialsci/blob/main/data/SAFI.json', simplifyVector = TRUE)
```
