...
If the user is defining a vector containing atomic elements with mixed data types, there is a convention for automatic type coercion, 
because of vectors can contain elements with identical types. Below is the illustration of R's built-in automatic type conversion hierarchy: 
