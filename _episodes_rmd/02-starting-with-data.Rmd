...
labels and they can be ordered or unordered. Factors are generally used to relate a single answer with a subset of allowed answers that are generally present in a survey. This makes it easier to see how one element relates to the other elements in a column. While factors look (and often
