...
**`dplyr`**) or 2) `|>` (called native R pipe and it comes preinstalled with R v4.1.0 onwards). Both pipes work similarly with a few differences that are unlikely to affect most users. For more information, check out [this blog post](https://www.tidyverse.org/blog/2023/04/base-vs-magrittr-pipe/).
