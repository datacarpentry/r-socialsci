...
~~~
Error in head(interviews): object 'interviews' not found
~~~
{: .error}
...
~~~
Error in plot(interviews$memb_assoc): object 'interviews' not found
~~~
{: .error}
...
~~~
Error in head(memb_assoc): object 'memb_assoc' not found
~~~
{: .error}
...
~~~
Error in levels(memb_assoc): object 'memb_assoc' not found
~~~
{: .error}
...
~~~
Error in levels(memb_assoc)[2] <- "Undetermined": object 'memb_assoc' not found
~~~
{: .error}
...
> > 
> > ~~~
> > Error in levels(memb_assoc)[c(1, 3)] <- c("No", "Yes"): object 'memb_assoc' not found
> > ~~~
> > {: .error}
> > 
> > 
...
~~~
Error in lapply(list(...), .num_to_date): object 'dates' not found
~~~
{: .error}
