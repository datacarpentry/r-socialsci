...
# Instead, please edit 02-reading.md in _episodes_rmd/
...
~~~
Error: 'data/SN7577.tab' does not exist in current working directory ('/Users/ebecker/Box Sync/Carpentry_repos/datacarpentry-lessons/socialsci/r-socialsci/_episodes_rmd').
~~~
{: .error}
...
~~~
Error in head(names(SN7577_tab)): object 'SN7577_tab' not found
~~~
{: .error}
...
~~~
Error in str(SN7577_tab, list.len = 6): object 'SN7577_tab' not found
~~~
{: .error}
...
> > 
> > ~~~
> > Error in eval(expr, envir, enclos): object 'SN7577_200' not found
> > ~~~
> > {: .error}
> > 
> > 
...
> > 
> > ~~~
> > Error in eval(expr, envir, enclos): object 'SN7577_last' not found
> > ~~~
> > {: .error}
> > 
> > 
...
> > 
> > ~~~
> > Error in eval(expr, envir, enclos): object 'SN7577_middle' not found
> > ~~~
> > {: .error}
> > 
> > 
...
> > 
> > ~~~
> > Error in eval(expr, envir, enclos): object 'SN7577_head' not found
> > ~~~
> > {: .error}
> >
> {: .solution}
...
~~~
Error: 'data/SAFI_results.csv' does not exist in current working directory ('/Users/ebecker/Box Sync/Carpentry_repos/datacarpentry-lessons/socialsci/r-socialsci/_episodes_rmd').
~~~
{: .error}
...
~~~
Error in as.POSIXct(SAFI_results$A04_start, format = "%Y-%m-%d %H:%M:%S"): object 'SAFI_results' not found
~~~
{: .error}
...
> > 
> > ~~~
> > Error in as.POSIXct(SAFI_results$A01_interview_date, format = "%d/%m/%Y"): object 'SAFI_results' not found
> > ~~~
> > {: .error}
> > 
> > 
...
~~~
Error in paste(SAFI_results$A01_day, SAFI_results$A01_month, SAFI_results$A01_year, : object 'SAFI_results' not found
~~~
{: .error}
