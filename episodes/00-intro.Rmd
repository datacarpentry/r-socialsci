...
<div class="columns-2">
<figure>
```{r rstudio-analogy, echo=FALSE, fig.show="hold", out.width="50%", fig.cap="RStudio extends what R can do, and makes it easier to write R code and interact with R."}	
knitr::include_graphics(c("../fig/r-manual.jpeg", "../fig/r-automatic.jpeg"))
```
<figcaption>
