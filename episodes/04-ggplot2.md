...
~~~
Error in ggplot(data = SAFI_results, aes(x = C03_respondent_floor_type, : object 'SAFI_results' not found
~~~
{: .error}
...
~~~
Error in ggplot(data = wall_avs, aes(x = C02_respondent_wall_type, y = av)): object 'wall_avs' not found
~~~
{: .error}
