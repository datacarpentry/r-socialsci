...
Now we can save this dataframe to our `data_output` directory. Note: from R version 4 and higher, you will get a warning message that "path" is deprecated. It will still work but is strongly discouraged. You can use "file = " instead. 
