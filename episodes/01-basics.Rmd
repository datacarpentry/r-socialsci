...
(area_hectares <- 1.0 )  # but putting parenthesis around the call prints the value of `area_hectares`
...
>   numeric (or double), integer, and logical. But what happens if we
> try to mix these types in
>   a single vector?
>
> > ## Solution
